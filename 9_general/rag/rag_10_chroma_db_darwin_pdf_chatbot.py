...
collection = client.get_or_create_collection(name="darwin_book")

PDF_PATH = r"c:/code/agenticai/9_general/rag/darwin.pdf"

CHUNK_SIZE_WORDS = 500
CHUNK_OVERLAP_WORDS = 100

# Below this similarity (1 - distance), the best chunk isn't actually about the
# question - e.g. "What is natural selection?" scores ~0.2-0.3, while
# off-topic questions like "capital of France?" score negative (~-0.6).
...
if collection.count() == 0:
    ...
    collection.add(
        ...
        metadatas=[{"chunk_index": i, "source": "darwin.pdf"} for i in range(len(chunks))]
    )
...
# RETRIEVAL FUNCTION
# --------------------------------
def query_darwin(user_question, n_results=3):
    ...
    if best_similarity >= SIMILARITY_THRESHOLD:
        ...
        prompt = (
            "This question is not covered by Darwin's 'On the Origin of Species'. "
...
if __name__ == "__main__":
    ...
    print("\n" + "="*70)
    print("Darwin Book Chatbot - Ask questions (type 'quit' to exit)")
    print("="*70)
